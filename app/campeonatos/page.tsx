          ...
          {campeonatos.map((c) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 pt-1 border-t border-[#E5E7EB] mt-auto">
                <button className="flex-1 flex items-center justify-center gap-1.5 h-[34px] rounded-[8px] border border-[#D1D5DB] text-[#374151] font-medium text-[13px] hover:bg-[#F9FAFB] transition-colors">
